    ...
    <footer className="bg-gradient-to-br from-pink-400 to-purple-600 text-white pt-20 pb-8 relative">
      ...
      <div className="container mx-auto px-4 relative">
        <motion.div
          ...
          className="bg-white bg-opacity-20 rounded-2xl p-6 mb-12 shadow-lg max-w-2xl mx-auto"
        >
          ...
          >
            <input
              ...
              className="flex-grow px-4 py-2 rounded-full text-purple-900 text-sm focus:outline-none focus:ring-2 focus:ring-purple-300"
              required
            />
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-6 py-2 bg-white text-purple-600 rounded-full text-sm font-semibold hover:bg-purple-100 transition duration-300"
              type="submit"
            >
              Subscribe
            </motion.button>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-sm">
          ...
          {[
            ...
            {
              title: "Support",
              links: ["Help Center", "Tweet @ Us", "Webinars", "Feedback"],
            },
            {
              title: "Links",
